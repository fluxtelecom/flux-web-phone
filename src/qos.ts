...
const publishQosStats = (session: WebPhoneSession, qosStatsObj: QosStats, options: any = {}): void => {
    ...
    const targetUrl = options.targetUrl || 'qosdev@dev.flux.net.br:5060';
    ...
    options.extraHeaders.push(
        'p-flux-client-info:' + 'cpuRC=0:0;cpuOS=0:0;netType=' + networkType + ';ram=0:0;effectiveType=' + effectiveType
    );
